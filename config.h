...
//  allow certain non-interactive (insecure) window operations such as setting clipboard text
...
// blinking timeout for terminal blinking
...
// Default colour and shape of mouse cursor
static unsigned int mouseshape = XC_xterm;
static unsigned int mousefg    = 7;
static unsigned int mousebg    = 0;

// color used to display font attributes when fontconfig selected font which doesn't match ones requested
